...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="sales_inventory.php"><i class="icon-cloud icon-2x"></i> Sales History</a>                </li>
			<br><br><br><br><br><br>		
			<li>
	...
	<div class="contentheader">
			<i class="icon-cloud"></i> Sales History
			</div>
<br>
...
<br><br><br>
<center><strong>Sales History</strong></center>
