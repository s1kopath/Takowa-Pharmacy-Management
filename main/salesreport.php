...
<a  href="sales_inventory.php"><center><button class="btn btn-danger btn-large" style="float: none;"><i class="icon icon-cloud icon-large"></i> Sales History</button></center></a>
