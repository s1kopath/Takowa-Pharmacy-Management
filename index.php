...
Takowa
    ...
    <link rel="shortcut icon" href="main/images/Takwa.jpg">
...
<form action="login.php" method="post">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 15px #000; color:#FFFFFF;"><center>Takowa Pharma</center></font>
		<br>
